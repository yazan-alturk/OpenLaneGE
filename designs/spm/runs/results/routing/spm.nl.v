module spm (clk,
 ...
 sky130_fd_sc_hd__inv_2 _442_ (.A(_199_),
    .Y(_096_));
 sky130_fd_sc_hd__dfrtp_1 _443_ (.CLK(clknet_3_1__leaf_clk),
    .D(_000_),
    .RESET_B(_033_),
    .Q(\csa0.sc ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _445_ (.CLK(clknet_3_7__leaf_clk),
    ...
    .RESET_B(_035_),
    .Q(\tcmp.z ));
 sky130_fd_sc_hd__dfrtp_1 _446_ (.CLK(clknet_3_3__leaf_clk),
    .D(_031_),
    .RESET_B(_036_),
    .Q(\genblk1[30].csa.y ));
 sky130_fd_sc_hd__dfrtp_1 _447_ (.CLK(clknet_3_4__leaf_clk),
    .D(_011_),
    .RESET_B(_037_),
    .Q(\genblk1[1].csa.sc ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _455_ (.CLK(clknet_3_0__leaf_clk),
    ...
    .RESET_B(_045_),
    .Q(\genblk1[5].csa.sc ));
 sky130_fd_sc_hd__dfrtp_1 _456_ (.CLK(clknet_3_5__leaf_clk),
 ...
 sky130_fd_sc_hd__dfrtp_1 _459_ (.CLK(clknet_3_4__leaf_clk),
    ...
    .RESET_B(_049_),
    .Q(\genblk1[7].csa.sc ));
 sky130_fd_sc_hd__dfrtp_1 _460_ (.CLK(clknet_3_7__leaf_clk),
    .D(\genblk1[7].csa.hsum2 ),
    .RESET_B(_050_),
    .Q(\genblk1[6].csa.y ));
 sky130_fd_sc_hd__dfrtp_1 _461_ (.CLK(clknet_3_5__leaf_clk),
    .D(_029_),
    .RESET_B(_051_),
    .Q(\genblk1[8].csa.sc ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _464_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .RESET_B(_054_),
    .Q(\genblk1[8].csa.y ));
 sky130_fd_sc_hd__dfrtp_1 _465_ (.CLK(clknet_3_4__leaf_clk),
    .D(_001_),
    .RESET_B(_055_),
    .Q(\genblk1[10].csa.sc ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _469_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .RESET_B(_059_),
    .Q(\genblk1[12].csa.sc ));
 sky130_fd_sc_hd__dfrtp_1 _470_ (.CLK(clknet_3_0__leaf_clk),
    .D(\genblk1[12].csa.hsum2 ),
    .RESET_B(_060_),
    .Q(\genblk1[11].csa.y ));
 sky130_fd_sc_hd__dfrtp_1 _471_ (.CLK(clknet_3_0__leaf_clk),
    .D(_004_),
    .RESET_B(_061_),
    .Q(\genblk1[13].csa.sc ));
 sky130_fd_sc_hd__dfrtp_1 _472_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .RESET_B(_062_),
    .Q(\genblk1[12].csa.y ));
 sky130_fd_sc_hd__dfrtp_1 _473_ (.CLK(clknet_3_0__leaf_clk),
    .D(_005_),
    .RESET_B(_063_),
    .Q(\genblk1[14].csa.sc ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _477_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .RESET_B(_067_),
    .Q(\genblk1[16].csa.sc ));
 sky130_fd_sc_hd__dfrtp_1 _478_ (.CLK(clknet_3_1__leaf_clk),
 ...
 sky130_fd_sc_hd__dfrtp_1 _483_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .RESET_B(_073_),
    .Q(\genblk1[19].csa.sc ));
 sky130_fd_sc_hd__dfrtp_1 _484_ (.CLK(clknet_3_4__leaf_clk),
    .D(\genblk1[19].csa.hsum2 ),
    .RESET_B(_074_),
    .Q(\genblk1[18].csa.y ));
 sky130_fd_sc_hd__dfrtp_1 _485_ (.CLK(clknet_3_2__leaf_clk),
    .D(_012_),
    .RESET_B(_075_),
    .Q(\genblk1[20].csa.sc ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _487_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .RESET_B(_077_),
    .Q(\genblk1[21].csa.sc ));
 sky130_fd_sc_hd__dfrtp_1 _488_ (.CLK(clknet_3_1__leaf_clk),
 ...
 sky130_fd_sc_hd__dfrtp_1 _490_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .RESET_B(_080_),
    .Q(\genblk1[21].csa.y ));
 sky130_fd_sc_hd__dfrtp_1 _491_ (.CLK(clknet_3_1__leaf_clk),
    .D(_015_),
    .RESET_B(_081_),
    .Q(\genblk1[23].csa.sc ));
 sky130_fd_sc_hd__dfrtp_1 _492_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .RESET_B(_082_),
    .Q(\genblk1[22].csa.y ));
 sky130_fd_sc_hd__dfrtp_1 _493_ (.CLK(clknet_3_4__leaf_clk),
    .D(_016_),
    .RESET_B(_083_),
    .Q(\genblk1[24].csa.sc ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _500_ (.CLK(clknet_3_5__leaf_clk),
    ...
    .RESET_B(_090_),
    .Q(\genblk1[26].csa.y ));
 sky130_fd_sc_hd__dfrtp_1 _501_ (.CLK(clknet_3_7__leaf_clk),
    .D(_020_),
    .RESET_B(_091_),
    .Q(\genblk1[28].csa.sc ));
 sky130_fd_sc_hd__dfrtp_1 _502_ (.CLK(clknet_3_7__leaf_clk),
    .D(\genblk1[28].csa.hsum2 ),
    .RESET_B(_092_),
    .Q(\genblk1[27].csa.y ));
 sky130_fd_sc_hd__dfrtp_1 _503_ (.CLK(clknet_3_6__leaf_clk),
    .D(_021_),
    .RESET_B(_093_),
    .Q(\genblk1[29].csa.sc ));
 sky130_fd_sc_hd__dfrtp_1 _504_ (.CLK(clknet_3_5__leaf_clk),
    ...
    .RESET_B(_094_),
    .Q(\genblk1[28].csa.y ));
 sky130_fd_sc_hd__dfrtp_2 _505_ (.CLK(clknet_3_7__leaf_clk),
    .D(_023_),
    .RESET_B(_095_),
    .Q(\genblk1[30].csa.sc ));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_2 (.DIODE(\genblk1[15].csa.hsum2 ));
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_92 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_189 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_2_188 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_3_188 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_4_95 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_9_188 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_16_43 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_17_12 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_18_112 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_19_16 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_25_43 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_27_12 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_27_176 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_28_189 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_29_63 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_29_134 ();
